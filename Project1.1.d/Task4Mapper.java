...
import project11.task4.Task4Driver.MyCounters;
...
public class Task4Mapper extends Mapper<LongWritable, Text, Text, LongWritable>
{
	...
	{	
		...
		Date currentDate =  new SimpleDateFormat("MM/dd/yyyyy HH:mm").parse(strDate);
